...
class AZSplitController: UIViewController {
    ...
    func openSide() {
        ...
        UIView.animateWithDuration(animationDuration, animations: {
            ...
            self.mainController.viewControllers.first?.navigationItem.leftBarButtonItem?.title = "Скрыть новости"
        })
    }
    ...
    return
        ...
        UIView.animateWithDuration(animationDuration, animations: {
            ...
            self.mainController.view.frame = mainFrame
            self.mainController.view.layoutIfNeeded()
            self.mainController.viewControllers.first?.navigationItem.leftBarButtonItem?.title = "Показать новости"
...
extension UINavigationController {
    func az_addMenuButton() {
        if let topItem = viewControllers.first?.navigationItem {
            topItem.leftBarButtonItem = UIBarButtonItem(title: "Скрыть новости", style: .Plain, target: self.az_splitController, action: "toggleSide")
        }
    }
